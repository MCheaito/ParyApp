...
namespace PrayerApp
{
    ...
    public class NotifyWindow : System.Windows.Forms.Form
    {
        ...
        public NotifyWindow(string title, string text, string imageName)
            : this(title, text)
        {
            Assembly assem = this.GetType().Assembly;
            Stream stream = assem.GetManifestResourceStream(imageName);
        ...
        protected override void OnPaintBackground(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (img != null) e.Graphics.DrawImage(img, 0, TitleFont.Height, this.Width, this.Height);
        ...
        protected void drawImageTheme(Graphics fx)
        {
            int offset;
            if (img == null) return;
            if (Title != null)
